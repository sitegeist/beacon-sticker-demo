...
<div id="header">
    ...
    <div class="col-50 centered">
        ...
        <p><a class="button" href="evo://beacon.sitegeist.intern/app/index.html">Open the App</a></p>
    ...
    <div class="col-50 centered only-desktop">
        <p><img src="images/screen-white.svg" height="150" /></p>
        <p><span id="btnRun" class="button">&raquo; Run</span></p>
        <p>This page demonstrates the Usage of estimote stickers. Press "Run" to start after you started the app on your iPhone.</p>
        <p class="result"></p>
